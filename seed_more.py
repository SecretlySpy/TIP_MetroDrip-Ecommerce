...
# Additional Products
p4, _ = Product.objects.get_or_create(slug="asphalt-puffer-jacket", defaults={
...
p5, _ = Product.objects.get_or_create(slug="drip-logo-beanie", defaults={
...
p6, _ = Product.objects.get_or_create(slug="tactical-crossbody-bag", defaults={
...
p7, _ = Product.objects.get_or_create(slug="acid-wash-hoodie", defaults={
