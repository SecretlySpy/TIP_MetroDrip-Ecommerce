...
# Flatpages
fp_about, _ = FlatPage.objects.get_or_create(
    url="/about/",
    defaults={
        "title": "About Us",
...
fp_contact, _ = FlatPage.objects.get_or_create(
    url="/contact/",
    defaults={
        "title": "Contact Us",
...
fp_privacy, _ = FlatPage.objects.get_or_create(
    url="/privacy/",
    defaults={
