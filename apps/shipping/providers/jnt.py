"""Real J&T Express courier adapter (E-2)."""
...
@register_provider("jnt")
class JNTShippingProvider(ShippingProvider):
    """J&T Express adapter."""
    ...
    def book_shipment(self, shipment):
        ...
        # Generate mock waybill for now as the actual API isn't fully implemented
        prefix = "JNT"
